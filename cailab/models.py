...
class Projects(models.Model):
    ...
    support_department = models.CharField(
        "주관부서", max_length=40, default=str, blank=True)
    support_institue = models.CharField(
        "지원기관", max_length=40, default=str, null=False)
    host_institute = models.CharField(
        "주관기관", max_length=40, default=str, null=False)
...
class News(models.Model):
    title = models.CharField("제목", max_length=300, default=str)
    date = models.DateField("날짜")
    year = models.IntegerField("년", default=int)
